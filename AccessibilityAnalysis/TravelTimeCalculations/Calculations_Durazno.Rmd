...
```{r}
road <- st_read("../RoadNetworks/Durazno/Durazno_Network_Cleaned.shp")
...
```{r}
EP <- st_read("../PublicSpaces/Durazno/Puntos_Durazno.shp") %>% 
  st_transform(st_crs(road)$epsg)


Polygon <- st_read("../DatosCenso/Durazno.shp") %>% 
...
write_delim(Population_OA, "Results/Durazno/MatrixOA_Durazon")
st_write(MinDistances_Population, "Results/Durazno/Pouplation_Durazno.shp")
