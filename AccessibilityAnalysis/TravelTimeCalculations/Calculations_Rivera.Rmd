...
```{r}
road <- st_read("../RoadNetworks/Rivera/RiveraNetwork_Cleaned.shp")
...
```{r}
EP <- st_read("../PublicSpaces/Rivera/Puntos_Rivera.shp") %>% 
...
write_delim(Population_OA, "Results/Rivera/MatrixOA_Rivera")
st_write(MinDistances_Population, "Results/Rivera/Pouplation_Rivera.shp")
